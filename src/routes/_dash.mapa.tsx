  ...
  return (
    <div className="space-y-6">
      ...
      <div className="grid grid-cols-1 xl:grid-cols-4 gap-6">
        <Panel
          title="Layout 2D"
          subtitle="Zonas · Pasillos · Rovers"
          icon={MapIcon}
            ...
            return (
              <div className="space-y-3 text-sm">
                ...
                <div>
                  ...
                  <span
                    className={`inline-flex items-center gap-1 px-2 py-0.5 rounded-full text-[11px] border ${stateStyles[r.state]}`}
                  >
                ...
                <div>
                  ...
                  <p className={`text-xs mt-1 ${bt.color}`}>
