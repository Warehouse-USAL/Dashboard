    ...
    <div className="space-y-6">
      ...
      <section className="grid grid-cols-1 sm:grid-cols-2 xl:grid-cols-4 gap-4">
        <KpiCard
          ...
          value={`${activeCount}/${rovers.length}`}
          icon={Truck}
          trend="+1 vs ayer"
          accent="primary"
        />
        <KpiCard
          ...
          icon={Activity}
          trend={`${waiting} en espera`}
          accent="accent"
        />
        <KpiCard
          label="Tiempo prom. por orden"
          value={`${avgTime} min`}
          icon={Zap}
        ...
        >
          <div className="space-y-2">
            {orders.slice(0, 5).map((o) => (
              ...
              >
                <div
                  className={`w-1 h-10 rounded-full ${o.priority === "alta" ? "bg-destructive" : o.priority === "media" ? "bg-warning" : "bg-primary"}`}
                />
                <div className="flex-1 min-w-0">
